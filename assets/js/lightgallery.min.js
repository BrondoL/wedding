    ...
    var T = function (t, e, i, s) {
        ...
        D = function (t, e, i, s, n, o) {
            var r =
                ...
                l = "";
            o &&
                (l = ("string" == typeof o ? JSON.parse(o) : o).map(function (
                    t
                ) {
                    var e = "";
                    return (
        ...
        k = function (t, e, i, s) {
            var n = [],
                o = (function () {
                    ...
                    for (e = 0; e < i; e++)
                        for (
                            var o = arguments[e], r = 0, l = o.length;
                            r < l;
                            r++, n++
                        )
                            s[n] = o[r];
        ...
        F = (function () {
            ...
            return (
                ...
                (w.prototype.buildStructure = function () {
                    ...
                    if (!(this.$container && this.$container.get())) {
                        ...
                        var n = this.settings.ariaLabelledby
                            ...
                            r =
                                ...
                                (document.body !== this.settings.container
                                    ? "lg-inline"
                                    : ""),
                            l = '<button type="button" aria-label="' +
                        ...
                        x(this.settings.container).append(d),
                            ...
                            (this.$backdrop =
                                this.getElementById("lg-backdrop")),
                            (this.$container =
                                this.getElementById("lg-container")),
                ...
                (w.prototype.getDummyImageContent = function (t, e, i) {
                    var s;
                    if (
                        (this.settings.dynamic || (s = x(this.items).eq(e)), s)
                    ) {
                        var n = void 0;
                        if (
                ...
                (w.prototype.triggerSlideItemLoad = function (t, e, i, s, n) {
                    var o = this,
                        ...
                        l =
                            n && "video" === this.getSlideType(r) && !r.poster
                                ? s
                                : 0;
                    setTimeout(function () {
                        t.addClass("lg-complete lg-complete_"),
                ...
                (w.prototype.manageSwipeClass = function () {
                    ...
                    this.settings.loop &&
                        ...
                        e > -1 &&
                            this.getSlideItem(e).addClass("lg-prev-slide"),
                    ...
                    return (
                        ...
                        setTimeout(function () {
                            e.zoomFromOrigin &&
                                ...
                                e.outer.removeClass(
                                    "lg-closing " + e.settings.startClass
                                ),
                                e
